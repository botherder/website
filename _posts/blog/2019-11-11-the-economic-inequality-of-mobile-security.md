---
layout: post
title: The Economic Inequality of Mobile Security
newsletter: True
categories: blog
---
...
Almost each new iPhone or Pixel generation comes with important new exploit mitigations or security improvements, increasingly dependant on the hardware and the chipset. They are not what dictates the exhorbitant prices though. You could instead attribute that to capitalism, sparkling through the lenses of brand new Triple Cameras or a Super Retina XDR display with a gazillion colors. Gadgetry is what sells.
...
I don't doubt many would happily renounce the Triple Cameras for a modern and secure mid-range phone, but I am equally sure the economic incentives are not there for companies like Google and Apple to even consider producing it. Older models still receiving software updates are not the answer either, as they still lack important hardware hardening. [This presentation](https://github.com/ssd-secure-disclosure/typhooncon2019/blob/master/Siguza%20-%20Mitigations.pdf) breaks down very well the progression of exploit mitigations (such as PAC, PPL, etc.) over recent generations of iPhones.
